    ...
    >
      <CardContent className="flex flex-col gap-3 px-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <Badge className="rounded-full bg-warning text-foreground dark:bg-warning-dark dark:text-bg">
            30%
          </Badge>
        </div>
        <div className="h-2 overflow-hidden rounded-full bg-surface-offset shadow-ring">
          <div className="h-full w-[30%] rounded-full bg-warning dark:bg-warning-dark" />
        </div>
